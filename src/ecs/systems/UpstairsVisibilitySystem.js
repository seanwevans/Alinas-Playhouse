...
export class UpstairsVisibilitySystem {
  ...
  update() {
    ...
    const targetOpacity = isUpstairs ? PARAMS.World.opacityVisible : PARAMS.World.opacityHidden;
    this.upstairsOpacity = THREE.MathUtils.lerp(this.upstairsOpacity, targetOpacity, PARAMS.World.upstairsLerp);
